  ...
  return (
    <section className="bg-white py-16 pt-20 md:py-32 dark:bg-[#171717]">
      <div className="mx-auto mb-40 px-6 sm:px-12 md:px-24 space-y-8 md:space-y-12">
        ...
        {/* Main content */}
        <div className="flex flex-col md:flex-row md:justify-between md:items-start md:gap-x-16">
          {/* Heading */}
          ...
          {/* Subheading + Button */}
          <div className="flex-1 flex flex-col space-y-6 mt-8 md:mt-0 md:ml-24">
            <TextEffect
              per="line"
              preset="fade-in-blur"
              speedSegment={0.3}
              delay={0.5}
              as="p"
              className="max-w-2xl text-xl sm:text-2xl text-pretty text-left"
            >
